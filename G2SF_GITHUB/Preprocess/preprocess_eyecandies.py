...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default=r'D:\Eyecandies', type=str, help="Original Eyecandies dataset path.")
    parser.add_argument('--target_dir', default=r'D:\Eyecandies_preprocessed', type=str, help="Processed Eyecandies dataset path")
    ...
    for category_dir in categories_list:
        if category_dir in ['CandyCane', 'ChocolateCookie', 'ChocolatePraline', 'Confetto']:
            continue

        print(args.dataset_path, category_dir)
        category_root_path = os.path.join(args.dataset_path, category_dir)
        print(category_root_path)
        ...
        for i in tqdm(range(0, num_train_files)):
        ...
        for i in tqdm(range(0, num_test_files)):
